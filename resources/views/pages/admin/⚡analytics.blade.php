...
new #[Layout('pages.admin.layout')] class extends Component 
{
    ...
    public function with(): array
    {
        ...
        $categoryRevenue = DB::table('rental_items')
            ...
            ->select('categories.name', DB::raw('SUM(rental_items.unit_price_cents * rental_items.quantity * DATEDIFF(rentals.end_at, rentals.start_at)) as category_total'))
...
<div>
    <x-slot name="heading">{{ __('Business Analytics') }}</x-slot>
    <x-slot name="subheading">{{ __('Key metrics and revenue insights.') }}</x-slot>
